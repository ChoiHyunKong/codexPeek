...
| 세로형 대시보드: 높이 360 이상 | Codex 정보 아래 Gmail → Claude 카드, 연결 관리, 넘치는 카드 내용 스크롤 |
...
창 높이를 360 이상으로 늘리면 **Gmail → Claude** 순서로 추가 카드가 나타납니다. 최소 너비에서도 동작하며, 기존의 작은 창은 Codex 핵심 정보를 유지합니다. 설정 또는 트레이 메뉴의 **이메일 · AI 연결**에서 연결하고 카드 표시를 끌 수 있습니다. Spotify·Gemini·Outlook은 아직 구현하지 않았습니다.
