...
2026-09-23 후속 UI 수정에서는 최소·기본·확대·전환 경계·좁고 긴 창·넓고 낮은 창·크기 복원 과 큰 창(640×480, 900×620), 주간 한도만 있는 확대 창 등 15개 화면을 렌더링했습니다. 핵심 글자와 그래프가 항상 유지되는지, 확대 상세 정보와 실패 시 이전 데이터 표시가 정확한지, 주간 한도만 제공하는 계정에 임의의 일간 한도를 추가하지 않는지 검증했습니다.
